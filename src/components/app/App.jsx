...
export class App extends React.Component {
    ...
    changePage = (e) => {
        if (e.target.value === "forward") {
            this.setState({pages: this.state.pages.map(elem => elem + 1)}, () => {
            ...
            this.setState({pages: this.state.pages.map(elem => elem - 1)}, () => {
                if (!this.state.pages.includes(this.state.page)) {
                    this.setState({page: this.state.pages[this.state.pages.length - 1]})
                }
            })
        } else {
        ...
        return(
            <>
                ...
                <main className={main.main}>
                    <Pagination pages={this.state.pages} page={this.state.page} totalPages={this.state.totalPages} changePage={this.changePage}/>
